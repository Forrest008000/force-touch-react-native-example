...
export default class forceTouchTest extends Component {
  constructor(props) {
    ...
    this._panResponderChild = this._panResponderChild.bind(this);
    this._panResponderParent = this._panResponderParent.bind(this);
    this.state = {
  ...
  componentWillMount() {
    this._panResponderChild();
    this._panResponderParent();
  }
